...
- 📦 **Import/Export** — 설정 파일을 공유하여 다른 사용자에게 전달
- 🚀 **Launch at Login** — 로그인 시 자동 시작 토글
- 🗑️ **Uninstall** — 설정창에서 앱 + 설정 + 로그인 항목 원클릭 제거
...
4. **Launch at Login** → 자동 시작 on/off

### 설정 공유

- Settings → **Export** → JSON 파일로 저장
- 상대방: Settings → **Import** → 받은 JSON 적용
